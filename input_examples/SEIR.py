...
processes = {'Susceptible':[walk], 'Exposed':[walk], 'Infectious':[walk]}
monomolecular = {'Susceptible':[], 'Exposed':[incub],'Infectious':[death,cure]}
#########################################################################################
...
exciton2  = morphology.Create_Particles('Infectious', 1, method, ages, mat=[1])
#########################################################################################
